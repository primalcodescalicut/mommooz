...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.App.FrontBundle.Model.map.AuthorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('App\\FrontBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', 'App\\FrontBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
