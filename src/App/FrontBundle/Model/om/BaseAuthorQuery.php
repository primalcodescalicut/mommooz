...
namespace App\FrontBundle\Model\om;
...
use \PropelPDO;
use App\FrontBundle\Model\Author;
use App\FrontBundle\Model\AuthorPeer;
use App\FrontBundle\Model\AuthorQuery;
use App\FrontBundle\Model\Book;
...
abstract class BaseAuthorQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'App\\FrontBundle\\Model\\Author';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \App\FrontBundle\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\App\FrontBundle\Model\BookQuery');
    }
