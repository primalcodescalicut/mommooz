...
use App\FrontBundle\Model\map\BookTableMap;
...
abstract class BaseBookPeer
{
    ...
    const OM_CLASS = 'App\\FrontBundle\\Model\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'App\\FrontBundle\\Model\\map\\BookTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \App\FrontBundle\Model\map\BookTableMap());
      }
    }
